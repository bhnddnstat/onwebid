...
class SecureController extends BaseController{
	function __construct(){
		...
		$exclude_pages = array('layanan/cuslistlayanan', 'pesanan/customadd', 'pesanan/customedit', 'pesanan/customview', 'layanansc/cuslistlayanansc', 'pesanansc/customscview', 'pesanansc/customscadd', 'pesanansc/customscedit');
		$url = Router :: $page_url;
