                        ...
                        <div class="container-fluid">
                            <div class="row justify-content-center">
                                <div class="col content-center comp-grid">
                                    <h3 class="mt-2 mb-3 font-weight-bold text-center">LAYANAN DIGITAL</h3>
                                    <a  class="btn col-sm-5 btn-pesan mb-3 font-weight-bold" href="<?php print_link("pesanan/customadd") ?>">
                                        <i class="material-icons ">local_grocery_store</i>                              
                                        PESAN LAYANAN 
                                    </a>
                                    <?php $this :: display_page_errors(); ?>
                                    <div  class=" animated fadeIn page-content">
                                        <div id="layanan-cuslistlayanan-records">
                                            <?php
                                            if(!empty($records)){
                                            ?>
                                                ...
                                                <div class="row justify-content-center page-data" id="page-data-<?php echo $page_element_id; ?>">
                                                    ...
                                                    <div class="col">
                                                        <div class="card alert-light p-3 mb-3 col-radius text-center">
                                                            ...
                                                            <div>
                                                                <a href="<?php echo $data['contoh_layanan']; ?>" class="col btn btn-demo font-weight-bold mt-2 mb-2" target="_blank">
                                                                    LIHAT CONTOH
                                                                </a>
                                                            </div>
