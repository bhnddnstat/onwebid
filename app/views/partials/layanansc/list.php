                        ...
                        <div class="container-fluid">
                            <div class="row justify-content-center">
                                <div class="col comp-grid">
                                    <h3 class="mt-2 mb-3 font-weight-bold text-center">DATA LAYANAN SC</h3>
                                    <a  class="btn btn-primary mb-2" href="<?php print_link("layanansc/add") ?>">
                                        <i class="material-icons ">add</i>                              
                                        TAMBAH LAYANAN 
                                    </a>
                                    <?php $this :: display_page_errors(); ?>
                                    <div  class=" animated fadeIn page-content">
                                        <div id="layanansc-list-records">
                                            <?php
                                            if(!empty($records)){
                                            ?>
                                                ...
                                                <div class="row justify-content-center page-data" id="page-data-<?php echo $page_element_id; ?>">
                                                    ...
                                                    <div class="col">
                                                        <div class="card alert-light p-3 mb-3 col-radius text-center">
                                                            ...
                                                            <div>
                                                                <a href="<?php echo $data['contoh_layanansc']; ?>" class="col btn btn-primary font-weight-bold mt-2 mb-2" target="_blank">
                                                                    LIHAT CONTOH
                                                                </a>
                                                            </div>
                                                            ...
                                                            <div class="td-btn">
                                                                <a class="btn btn-sm btn-info has-tooltip" title="Edit This Record" href="<?php print_link("layanansc/edit/$rec_id"); ?>">
                                                                    <i class="material-icons">edit</i> 
                                                                </a>
                                                                <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" title="Delete this record" href="<?php print_link("layanansc/delete/$rec_id/?csrf_token=$csrf_token"); ?>" data-prompt-msg="Yakin menghapus data ini ?" data-display-style="modal">
