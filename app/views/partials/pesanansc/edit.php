            ...
            <div class="row justify-content-center">
                <div class="col-sm-7 col-border alert-primary col-radius ">
                    ...
                    <div  class="card p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("pesanansc/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <div class="">
                                                                                    <select required=""  id="ctrl-status_pembayaran" name="status_pembayaran"  placeholder="Pilih status pembayaran"    class="custom-select" >
                                                                                        ...
                                                                                        $field_value = $data['status_pembayaran'];
