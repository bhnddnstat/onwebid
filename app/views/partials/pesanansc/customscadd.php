            ...
            <div class="row justify-content-center">
                <div class="col-sm-7 col-border form-color col-radius ">
                    ...
                    <div  class="card p-3 forms-color animated fadeIn page-content">
                        <form id="pesanansc-customscadd-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("pesanansc/customscadd?csrf_token=$csrf_token") ?>" method="post">
                            <div>
...
<div class="form-group form-submit-btn-holder text-center mt-3">
    ...
    <button class="btn btn-danger" type="button" onclick="window.location.href='<?php print_link(""); ?>'">
