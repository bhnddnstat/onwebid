                        ...
                        <div class="p-3 d-flex">
                            <div class="dropup export-btn-holder mx-1">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <a class="btn btn-sm btn-danger record-delete-btn mx-1"  href="<?php print_link("user/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Yakin menghapus data ini ?" data-display-style="modal">
